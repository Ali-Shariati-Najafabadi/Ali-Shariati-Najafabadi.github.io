    ...
    <div className="min-h-screen bg-paper text-ink flex flex-col font-sans">
      ...
      <header className="border-b border-line">
        <nav className="container mx-auto px-6 py-6">
          <div className="flex flex-wrap justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-8">
              ...
              <button
                ...
                className="flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-muted hover:text-accent transition-colors"
              >
                <Globe size={14} />
                {language === 'de' ? 'EN' : 'DE'}
              </button>
          ...
          {/* Mobile nav */}
          <div className="flex md:hidden gap-5 font-mono text-xs uppercase tracking-wider mt-4 overflow-x-auto">
            {sectionKeys.map((key) => (
              <button
                key={key}
                onClick={() => setActiveSection(key)}
                className={`pb-1 border-b whitespace-nowrap transition-colors duration-200 ${
                  activeSection === key
                    ? 'text-accent border-accent'
      ...
      <section className="container mx-auto px-6 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-start gap-12 max-w-5xl mx-auto">
          ...
          <div className="flex-1">
            <h1 className="font-serif text-5xl md:text-6xl font-medium text-ink leading-[1.05] mb-5">
              {t.hero.title}
            </h1>
            <p className="text-lg md:text-xl text-muted leading-relaxed mb-4 max-w-xl">
              {t.hero.subtitle}
            </p>
            <p className="font-mono text-sm text-accent uppercase tracking-wide mb-8">
              {t.hero.tagline}
            </p>
            <div className="flex flex-wrap gap-x-8 gap-y-3">
              <a href="mailto:alishariaty0854@gmail.com" className="flex items-center gap-2 text-ink border-b border-ink pb-0.5 hover:text-accent hover:border-accent transition-colors">
                <Mail size={16} />
                {t.hero.contact}
              </a>
              <a href="https://github.com/Ali-Shariati-Najafabadi" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-ink border-b border-ink pb-0.5 hover:text-accent hover:border-accent transition-colors">
                <Github size={16} />
                GitHub
              </a>
              <a href="https://www.linkedin.com/in/ali-shariati-najafabadi-b69063220/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-ink border-b border-ink pb-0.5 hover:text-accent hover:border-accent transition-colors">
                <Linkedin size={16} />
                LinkedIn
              </a>
            </div>
      ...
      <main className="container mx-auto px-6 pb-20 flex-1">
        <div className="max-w-5xl mx-auto">
          {/* About Section */}
          {activeSection === 'about' && (
            <div className="border-t border-line pt-10 animate-fade-in">
              <div className="flex items-baseline gap-4 mb-10">
                <span className="font-mono text-sm text-accent">{sectionIndex.about}</span>
                <h2 className="font-serif text-3xl font-medium text-ink">{t.about.title}</h2>
              </div>
                    ...
                    {[
                      ...
                      <div key={lang.label}>
                        ...
                        <div className="h-1.5 bg-line">
                          <div className="h-full bg-accent" style={{ width: lang.fill }}></div>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          {activeSection === 'experience' && (
            <div className="border-t border-line pt-10 animate-fade-in">
              <div className="flex items-baseline gap-4 mb-10">
                <span className="font-mono text-sm text-accent">{sectionIndex.experience}</span>
                <h2 className="font-serif text-3xl font-medium text-ink">{t.experience.title}</h2>
              </div>
              <div className="space-y-10">
                {t.experience.positions.map((job, index) => (
                  <div key={index} className="pl-6 border-l border-line">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-baseline mb-3 gap-1">
                      ...
                      <span className="font-mono text-xs uppercase tracking-wider text-accent">{job.period}</span>
                    </div>
                    {job.tasks.length > 0 && (
          ...
          {activeSection === 'education' && (
            <div className="border-t border-line pt-10 animate-fade-in">
              <div className="flex items-baseline gap-4 mb-10">
                <span className="font-mono text-sm text-accent">{sectionIndex.education}</span>
                <h2 className="font-serif text-3xl font-medium text-ink">{t.education.title}</h2>
              </div>
              <div className="space-y-10">
                {t.education.positions.map((edu, index) => (
                  <div key={index} className="pl-6 border-l border-line">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-baseline mb-3 gap-1">
                      ...
                      <span className="font-mono text-xs uppercase tracking-wider text-accent">{edu.period}</span>
                    </div>
                    {edu.note && (
          ...
          {activeSection === 'projects' && (
            <div className="border-t border-line pt-10 animate-fade-in">
              <div className="flex items-baseline gap-4 mb-10">
                <span className="font-mono text-sm text-accent">{sectionIndex.projects}</span>
                <h2 className="font-serif text-3xl font-medium text-ink">{t.projects.title}</h2>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <a
                  ...
                  className="border border-line p-6 hover:border-accent transition-colors duration-300 group"
                >
                  ...
                  <div className="flex flex-wrap gap-2 font-mono text-xs">
                    <span className="border border-line px-2 py-1">Python</span>
                    <span className="border border-line px-2 py-1">PyTorch</span>
                    <span className="border border-line px-2 py-1">Computer Vision</span>
                  </div>
                </a>

                <div className="border border-line p-6 hover:border-accent transition-colors duration-300 group">
                  <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex flex-wrap gap-2 font-mono text-xs">
                    <span className="border border-line px-2 py-1">Python</span>
                    <span className="border border-line px-2 py-1">React</span>
                    <span className="border border-line px-2 py-1">Security</span>
                  </div>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border border-line p-6 hover:border-accent transition-colors duration-300 group md:col-span-2"
                >
                  <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex flex-wrap gap-2 font-mono text-xs">
                    <span className="border border-line px-2 py-1">Python</span>
                    <span className="border border-line px-2 py-1">PyTorch</span>
                    <span className="border border-line px-2 py-1">NLP</span>
                    <span className="border border-line px-2 py-1">BLIP-2</span>
                  </div>
                </a>
              </div>
            </div>
          ...
          {activeSection === 'skills' && (
            <div className="border-t border-line pt-10 animate-fade-in">
              <div className="flex items-baseline gap-4 mb-10">
                <span className="font-mono text-sm text-accent">{sectionIndex.skills}</span>
                <h2 className="font-serif text-3xl font-medium text-ink">{t.skills.title}</h2>
              </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Python', 'Java', 'JavaScript', 'TypeScript', 'SQL', 'C++'].map(skill => (
                      <span key={skill} className="border border-line px-3 py-1.5 text-sm hover:border-accent hover:text-accent transition-colors">
                        {skill}
                      </span>
                    ))}
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-5">
              <a href="https://github.com/Ali-Shariati-Najafabadi" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent transition-colors">
                <Github size={18} />
              </a>
              <a href="https://www.linkedin.com/in/ali-shariati-najafabadi-b69063220/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent transition-colors">
                <Linkedin size={18} />
              </a>
              <a href="mailto:alishariaty0854@gmail.com" className="text-muted hover:text-accent transition-colors">
                <Mail size={18} />
              </a>
            </div>
          </div>
